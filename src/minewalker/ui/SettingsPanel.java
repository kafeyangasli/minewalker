...
public class SettingsPanel extends JPanel {
    public SettingsPanel(GameSettings initialSettings, Consumer<GameSettings> startGame, Runnable back,
        ...
        JLabel title = new JLabel("PLAY SETTINGS", SwingConstants.CENTER);
        ...
        JSlider mines = new JSlider(5, 45, initialSettings.getMinePercentage());
        ...
        JCheckBox timer = new JCheckBox("TIMER ENABLED", initialSettings.isTimerEnabled());
